...
palabras = """valoracion aprenderpython comida juego python web imposible
           ...
           lapicero celular valor revista gratuito disco voleibol anillo
           estrella""".split()
...
def elije_letra(algunaLetra):
    """Devuelve la letra que el jugador ingreso. Esta función hace que el
    jugador ingrese una letra y no cualquier otra cosa"""
    while True:
...
while True:
    ...
    if letra in palabraSecreta:
        ...
        """Comprueba la cantidad de letras que ha ingresado el jugador
        y si perdió"""
        if len(letraIncorrecta) == len(AHORCADO) - 1:
            ...
            print('¡Se ha quedado sin letras!\nDespues de '
                  ...
                  + str(len(letraCorrecta)) + ' letras correctas, \
